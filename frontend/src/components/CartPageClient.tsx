...
export function CartPageClient() {
  ...
  const fetchItems = async () => {
    ...
    } else if (ItemsResponse.status === 200) {
  ...
  return (
    <div className="flex justify-center w-full min-h-[90vh] mb-10">
        ...
        <div className="flex sm:flex-col lg:flex-row gap-6 w-full h-full">
          {!cartItems.length || loading ? (
            ...
            <div className="flex flex-col md:flex-row lg:flex-row gap-20 h-full w-full">
              ...
              <div
                className="px-5 py-5 sm:flex sm:w-full md:w-[40%] lg:w-[25%] bg-white/5 h-[20%]
              ...
              >
                ...
                <button
                  className="text-black border border-solid
