...
export function SmartPhoneCard({ id, src, brand, name, price, alt }: Props) {
  ...
  return (
    <div
      className="w-[95%] rounded-3xl gap-3 flex flex-col items-center
         border border-solid border-white/10 bg-white/5 pb-4 cursor-pointer hover:scale-[102%]
         hover:border-white/30 transition-all duration-200 group mb-4 hover:shadow-xl hover:shadow-white/10
         "
    ...
    >
      ...
      <div className="mt-2 flex flex-col gap-2 w-[85%]">
        ...
        <div className="flex w-full justify-between">
          ...
          <p
            className="text-lg group-hover:translate-x-2
