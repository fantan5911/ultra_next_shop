    ...
    function flushLayoutEffects() {
        if (pendingEffectsStatus === PENDING_LAYOUT_PHASE) {
            ...
            if (null !== suspendedViewTransitionReason) {
                ...
                !supportsUserTiming || endTime <= startTime || (("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : console.timeStamp(suspendedViewTransitionReason, startTime, endTime, currentTrack, LANES_TRACK_GROUP, "secondary-light"));
            }
    ...
    function flushSpawnedWork() {
        if (pendingEffectsStatus === PENDING_SPAWNED_WORK || pendingEffectsStatus === PENDING_AFTER_MUTATION_PHASE) {
            if (pendingEffectsStatus === PENDING_SPAWNED_WORK) {
                ...
                !supportsUserTiming || endTime <= startViewTransitionStartTime || (("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : console.timeStamp(abortedViewTransition ? "Interrupted View Transition" : "Starting Animation", startViewTransitionStartTime, endTime, currentTrack, LANES_TRACK_GROUP, abortedViewTransition ? " error" : "secondary-light"));
